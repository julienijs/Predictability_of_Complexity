...
# read data
morph_data <- read_xlsx("Unita_Morph_Zipped.xlsx", col_names = TRUE)
zipped <- read_xlsx("Unita_Zipped_Sizes.xlsx", col_names = TRUE)
...
# read data
synt_data <- read_xlsx("Unita_Synt_Zipped.xlsx", col_names = TRUE)
...
morph_ts <- ts(morph_and_synt$morph, start = 1948, frequency = 1)
...
synt_ts <- ts(morph_and_synt$synt, start = 1948, frequency = 1)
...
tsDF <- data.frame(Year = seq(from = 1948, to = 2014, by = 1),
                   "Syntax" = synt_ts,
                   "Morphology" = morph_ts)
...
years <- seq(1948, 2014, by = 10)  # Starting from 1948, incrementing by 10 until 2014
last_year <- 2014
years <- c(years, last_year)  # Include 2014
